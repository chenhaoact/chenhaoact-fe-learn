...
注：React版本为当前最新的正式版 （v15.6.1，实际tag版本为16.0.0-beta.5），之后 React16 正式发布后会更新一篇 正式版React16 源码阅读的文章。
...
[Reacr官网文档-React代码架构概要分析](https://facebook.github.io/react/contributing/codebase-overview.html)

[Reacr官网文档-React实现注意](https://facebook.github.io/react/contributing/implementation-notes.html)
